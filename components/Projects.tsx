      ...
      <div className="w-full flex flex-col items-center justify-center gap-28 mt-10">
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <p className="bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md">
              A booking application for office people in which application allowed authorized users to reserve office rooms, 
              cancel bookings and perform check-ins when they arrived at the office. {" "}
        ...
        <div className="flex flex-col xl:flex-row-reverse gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right z-10">
            ...
            I enhanced the frontend of a Turkey project based on specific client requirements,
             collaborating with the Microsoft SQL Server backend. Additionally, 
